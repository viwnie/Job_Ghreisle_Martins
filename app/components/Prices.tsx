const Prices = () => {
	return (
		<div className="flex w-full bg-white text-black p-10 gap-10 justify-center max-lg:flex-col max-md:gap-10 max-lg:items-center">
			<div className="bg-white w-[320px] h-[370px] rounded-[20px] shadow-2xl p-6">
